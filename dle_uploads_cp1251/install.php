...
function makeDropDown($options, $name, $selected, $vers = '')
{
	...
	$output = "<select{$vers_sel} onclick=\"freeze(0)\" name=\"$name\">\r\n";
...
<li>На сайте также может быть установлен блоки: "Последние сообщения с форума", "Кто на сайте" </li>
...
break;
		...
		if ($_REQUEST['subaction'] == "save" && count($save_con))
		{
        	...
        	{
        	    $db->query("INSERT IGNORE `" . PREFIX . "_admin_sections` (allow_groups, name, icon, title, descr) VALUES ('all', 'dle_ipb', 'dle_ipb.gif', 'DLE + IPB3', 'Settings integration')");
        	}
		}
...
HTML;
	...
	showRow_install($lang_dle_ipb['ipb_version'], $lang_dle_ipb['ipb_version_desc'], makeDropDown(array(0 => $lang_dle_ipb['ipb_version_a4.0'], 1 => $lang_dle_ipb['ipb_version_a4.2']), "save_con[ipb_version]", 1, 1));
...
for ($i=0; $i<=$step_count; $i++)
{
	...
	elseif ($i == $step_count)$bar .= "<img src=\"" . $config['http_home_url'] . "engine/skins/images/dle_ipb.gif\" /";
...
<html>
<head>
<title>DataLife Engine +  Invision Power Board</title>
...
<table width="100%">
    ...
    <tr>
        <td background="engine/skins/images/tl_lb.gif"><img src="engine/skins/images/tl_lb.gif" width="4" height="1" border="0"></td>
        <td style="padding:5px;" bgcolor="#FFFFFF">
<center><font style="font-size:22px; font-weight:bold; font-family:Verdana, Arial, Helvetica, sans-serif; font-stretch:expanded; color:#333333;">DLE +  Invision Power Board</font> <font style="color:#666666">&nbsp;&nbsp;v$version</font></center>
</td>
        <td background="engine/skins/images/tl_rb.gif"><img src="engine/skins/images/tl_rb.gif" width="6" height="1" border="0"></td>
    </tr>
    <tr>
...
<table width="100%">
    <tr>
        <td bgcolor="#EFEFEF" height="40" align="center" style="padding-right:10px;"><div class="navigation">Copyright © 2017 created by <a href="mailto:pbh.folez@mail.ru" style="text-decoration:underline;color:green">FoLez</a><br/><a href="https://vk.com/vareckiy777" >VK</a></div></td>
    </tr>
</table></div>		
		</td>
